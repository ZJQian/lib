class MovieModel {
  ...
  MovieModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['subjects'] != null) {
      subjects = new List<MovieItemModel>();
      json['subjects'].forEach((v) {
        subjects.add(new MovieItemModel.fromJson(v));
      });
    }
    title = json['title'];
  }
...
class MovieItemModel {
  ...
  String subtype;
  List<DirectorItemModel> directors;
  ...
  MovieItemModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['directors'] != null) {
      directors = new List<DirectorItemModel>();
      json['directors'].forEach((v) {
        directors.add(new DirectorItemModel.fromJson(v));
      });
    }
...
class DirectorItemModel {
  ...
  DirectorItemModel({this.avatars, this.nameEn, this.name, this.alt, this.id});

  DirectorItemModel.fromJson(Map<String, dynamic> json) {
    avatars =
        json['avatars'] != null ? new Avatars.fromJson(json['avatars']) : null;
    nameEn = json['name_en'];
    name = json['name'];
